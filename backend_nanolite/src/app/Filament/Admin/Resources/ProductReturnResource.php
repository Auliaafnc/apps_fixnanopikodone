    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            BadgeColumn::make('status_return')->label('Status Return')
                ...
                TextColumn::make('rejection_comment')->label('Alasan Penolakan'),
                TextColumn::make('cancelled_comment')->label('Alasan Cancel'),
                ...
                Action::make('export')->label('Export Data Return')
                    ->form([
                        Grid::make(4)->schema([
                            ...
                            Select::make('status_return')->label('Status Return')->options(['pending'=>'Pending','confirmed'=>'Confirmed','processing'=>'Processing','on_hold'=>'On Hold','delivered'=>'Delivered','completed'=>'Completed','cancelled'=>'Cancelled','rejected'=>'Ditolak']),
